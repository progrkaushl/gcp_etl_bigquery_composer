...
gcs cp ${PWD}/data/OfficeData.csv ${GCS_DATA_PATH}/office_data/OfficeData.csv
gcs cp ${PWD}/data/OfficeDataProject.csv ${GCS_DATA_PATH}/office_data/OfficeDataProject.csv
